...
#define WriteBuffRva 0x1252C70
#define ReadBuffRva 0x1252B40
#define ReadBuffHookRva ReadBuffRva + 0x102

#define g_公共发包CALLRVA 0x1252E00
#define g_公共收包RVA 0x15F2A60 + 0x46 //(-0x80)48 8B 0F 48 8B 01 4C 8B C3 0F B7 D6                             $+46             00007FF76BDC2AA6           | 48:8D9424 80010000       | lea rdx,qword ptr ss:[rsp+180]                                      |
